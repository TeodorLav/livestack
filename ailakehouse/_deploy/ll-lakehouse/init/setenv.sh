...

{
  ...
  echo "SOURCE_PUBLIC_HOST=${SOURCE_PUBLIC_HOST:-${PUBLIC_IP}}"
  ...
  echo "MONGODB_CATALOG_PORT=${MONGODB_CATALOG_PORT:-27017}"
  ...
  echo "GRAVITINO_HTTP_PORT=${GRAVITINO_HTTP_PORT:-1525}"
